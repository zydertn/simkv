...
//		String monthString = "";
//		if (bill.getMonth() < 9) {
//			monthString += "0" + bill.getMonth()+1;
//		} else {
//			monthString += bill.getMonth()+1;
//		}
//		String mapString = "";
//		if (bill.getMapCount() > 1) {
//			mapString += "_" + bill.getMapCount();
//		}
//		
//		select += " where bill.filename = '" + bill.getCustomerNumber() + "_" + bill.getYear() + "-" + monthString + mapString + ".pdf'";
